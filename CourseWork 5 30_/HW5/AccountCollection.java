...
public class AccountCollection
{
    ...
    /**
     * Adds an account
     * @Param account add account to index
     */
     ...
     *@return (currentIndex) number of accounts
     */
     ...
     *@retuen account index with given account number
     *else return -1
     */
     ...
     * @return true if correct if not return false
     ...
     * @return account print account details
     */
